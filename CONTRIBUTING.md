...
If you'd like to help make RSpec better, here are some ways you can contribute:
  ...
  - by [reporting bugs you encounter](https://github.com/rspec/rspec-dev/issues/new)
  - by [suggesting new features](https://github.com/rspec/rspec-dev/issues/new)
  ...
  - by taking part in [feature and issue discussions](https://github.com/rspec/rspec-dev/issues)
  - by adding a failing test for reproducible [reported bugs](https://github.com/rspec/rspec-dev/issues)
  - by reviewing [pull requests](https://github.com/rspec/rspec-dev/pulls) and suggesting improvements
